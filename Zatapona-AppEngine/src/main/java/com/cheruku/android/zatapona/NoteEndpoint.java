...
@Api(name = "noteendpoint", namespace = @ApiNamespace(ownerDomain = "cheruku.com", ownerName = "cheruku.com", packagePath = "android.zatapona"))
public class NoteEndpoint {
    ...
    public Note removeNote(@Named("id") String id) {
        EntityManager mgr = getEntityManager();
        Note note = null;
        try {
            note = mgr.find(Note.class, id);
