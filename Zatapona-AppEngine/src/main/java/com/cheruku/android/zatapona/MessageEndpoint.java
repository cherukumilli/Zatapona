 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "cheruku.com", ownerName = "cheruku.com", packagePath = "android.zatapona"))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyA6M7e5ieC6uyQ6Dq-5GIBrKD6FynTf_yY";
