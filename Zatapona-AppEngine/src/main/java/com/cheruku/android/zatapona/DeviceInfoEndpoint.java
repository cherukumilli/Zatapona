...
import com.cheruku.android.zatapona.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "cheruku.com", ownerName = "cheruku.com", packagePath = "android.zatapona"))
