...
import com.cheruku.android.zatapona.MainActivity;
import com.cheruku.android.zatapona.R;
...
public class SampleMediaRouteControllerDialog extends MediaRouteControllerDialog
    ...
    public View onCreateMediaControlView(Bundle savedInstanceState) {
        Log.v(TAG, "in onCreateMediaControlView");
        LayoutInflater inflater = getLayoutInflater();
        View controls = inflater.inflate(R.layout.sample_media_route_controller_controls_dialog, null);
